...
const DIMENSION_LABELS: Record<number, { readonly zh: string; readonly en: string; readonly ru: string }> = {
  1: { zh: "OOC检查", en: "OOC Check", ru: "OOC: проверка характера" },
  2: { zh: "时间线检查", en: "Timeline Check", ru: "Хронология" },
  3: { zh: "设定冲突", en: "Lore Conflict Check", ru: "Конфликт сеттинга" },
  4: { zh: "战力崩坏", en: "Power Scaling Check", ru: "Сила и иерархия" },
  5: { zh: "数值检查", en: "Numerical Consistency Check", ru: "Числовая согласованность" },
  6: { zh: "伏笔检查", en: "Hook Check", ru: "Завязки и крючки" },
  7: { zh: "节奏检查", en: "Pacing Check", ru: "Темп" },
  8: { zh: "文风检查", en: "Style Check", ru: "Стиль и язык" },
  9: { zh: "信息越界", en: "Information Boundary Check", ru: "Границы информации" },
  10: { zh: "词汇疲劳", en: "Lexical Fatigue Check", ru: "Лексическая усталость" },
  11: { zh: "利益链断裂", en: "Incentive Chain Check", ru: "Цепочка интересов и мотивов" },
  12: { zh: "年代考据", en: "Era Accuracy Check", ru: "Историческая точность эпохи" },
  13: { zh: "配角降智", en: "Side Character Competence Check", ru: "Компетентность второстепенных персонажей" },
  14: { zh: "配角工具人化", en: "Side Character Instrumentalization Check", ru: "Второстепенные как функции" },
  15: { zh: "爽点虚化", en: "Payoff Dilution Check", ru: "Размывание катарсиса" },
  16: { zh: "台词失真", en: "Dialogue Authenticity Check", ru: "Достоверность диалогов" },
  17: { zh: "流水账", en: "Chronicle Drift Check", ru: "Скатывание в перечень событий" },
  18: { zh: "知识库污染", en: "Knowledge Base Pollution Check", ru: "Загрязнение базы знаний" },
  19: { zh: "视角一致性", en: "POV Consistency Check", ru: "Согласованность точки зрения" },
  20: { zh: "段落等长", en: "Paragraph Uniformity Check", ru: "Однородность абзацев" },
  21: { zh: "套话密度", en: "Cliche Density Check", ru: "Плотность штампов" },
  22: { zh: "公式化转折", en: "Formulaic Twist Check", ru: "Шаблонные повороты" },
  23: { zh: "列表式结构", en: "List-like Structure Check", ru: "Структура «списком»" },
  24: { zh: "支线停滞", en: "Subplot Stagnation Check", ru: "Застой побочных линий" },
  25: { zh: "弧线平坦", en: "Arc Flatline Check", ru: "Плоская арка" },
  26: { zh: "节奏单调", en: "Pacing Monotony Check", ru: "Монотонность темпа" },
  27: { zh: "敏感词检查", en: "Sensitive Content Check", ru: "Чувствительный контент" },
  28: { zh: "正传事件冲突", en: "Mainline Canon Event Conflict", ru: "Конфликт с событиями канона" },
  29: { zh: "未来信息泄露", en: "Future Knowledge Leak Check", ru: "Утечка будущей информации" },
  30: { zh: "世界规则跨书一致性", en: "Cross-Book World Rule Check", ru: "Согласованность правил мира между книгами" },
  31: { zh: "番外伏笔隔离", en: "Spinoff Hook Isolation Check", ru: "Изоляция завязок спин-оффа" },
  32: { zh: "读者期待管理", en: "Reader Expectation Check", ru: "Управление ожиданиями читателя" },
  33: { zh: "章节备忘偏离", en: "Chapter Memo Drift Check", ru: "Отклонение от памятки главы" },
  34: { zh: "角色还原度", en: "Character Fidelity Check", ru: "Верность характерам канона" },
  35: { zh: "世界规则遵守", en: "World Rule Compliance Check", ru: "Соблюдение правил мира" },
  36: { zh: "关系动态", en: "Relationship Dynamics Check", ru: "Динамика отношений" },
  37: { zh: "正典事件一致性", en: "Canon Event Consistency Check", ru: "Согласованность канонических событий" },
};
...
description 中要明确引用 hook_id，并把状态列中 stale / blocked 的原文标记字面抄进去。本维度只审结构，不评价伏笔文笔。`;
    ...
    case 33:
      ...
      if (language === "ru") {
        return "Сверяем готовый текст с приложенной к главе chapter_memo. Закрыл ли финальный текст goal из памятки и оставил ли видимый след по каждому из 7 разделов памятки (## Текущая задача / ## Закрыть · Не открывать / ## Что несут спокойные · переходные такты / ## Тройной вопрос по ключевому выбору / ## Обязательные сдвиги к финалу главы / ## Не делать и т. д.)? Пропущенный или вывернутый наизнанку раздел → critical. Важно: разрежённая памятка (глава-передышка, только goal + скелет body) — легитимна; проверяем дрейф только по тем разделам, которые памятка реально заполнила. Сама по себе разрежённость памятки не является нарушением.";
      }
